...
async function cleanForProduction() {
  try {
    ...
    // 4. Limpar conversas de indicações (antes de limpar indicações)
    console.log("\n4. Limpando conversas de indicações...");
