    ...
    <footer className="bg-gray-800">
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex justify-center space-x-6">
          <a href="https://www.facebook.com/kongprotecaoveicular" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-300">
          ...
          <a href="https://www.instagram.com/kongprotecao/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-300">
          ...
          <a href="https://www.kongprotecaoveicular.com.br/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-300">
        ...
        <p className="mt-8 text-center text-base text-gray-400">
          &copy; {new Date().getFullYear()} Kong Pix. Software registrado no INPI sob nº 51202500***-*. Todos os direitos reservados.
        </p>
        <p className="mt-2 text-center text-xs text-gray-500">
          <span title="Software protegido pelas Leis 9.609/98 e 9.610/98. Proibida a reprodução não autorizada.">
            INDIQUE-KP25-{new Date().getFullYear()}-9D7F4B2E835CAC1170-REG-INPI
          </span>
        </p>
      </div>
    </footer>
