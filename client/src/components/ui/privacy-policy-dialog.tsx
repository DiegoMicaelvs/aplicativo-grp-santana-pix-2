    ...
    <Dialog>
      ...
      <DialogContent className="max-w-4xl max-h-[80vh]">
        <DialogHeader>
          ...
          <DialogDescription>
            Programa "Indique e Ganhe" - LeadFlow
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4 text-sm">
            <div>
              <p className="font-semibold">
                LeadFlow, pessoa jurídica de direito privado, com sede em território nacional, doravante denominada "LEADFLOW", apresenta os termos abaixo para a participação no programa de incentivo denominado "Indique e Ganhe", disponibilizado por meio de seu aplicativo oficial.
              </p>
              <p className="mt-2">
            ...
            <div>
              ...
              <p>1.1. O programa "Indique e Ganhe" tem como finalidade incentivar a divulgação e o crescimento da base de usuários da plataforma do LEADFLOW, mediante bonificação por indicações válidas realizadas por usuários cadastrados.</p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2">2.3. O LEADFLOW reserva-se o direito de recusar cadastros ou desconsiderar indicações em caso de suspeita de fraude, duplicidade, inconsistência de dados ou qualquer outra irregularidade identificada durante a validação.</p>
            ...
            <div>
              ...
              <p className="mt-2">3.4. Os valores serão pagos exclusivamente por meio dos dados bancários ou contas cadastradas e validadas pelo próprio usuário no aplicativo. O LEADFLOW não se responsabiliza por erros de informação ou por dados incompletos/inválidos fornecidos pelo participante.</p>
              <p className="mt-2">3.5. Além da bonificação de R$ 3,00 por cada indicação válida, o usuário também fará jus ao recebimento adicional de R$ 50,00 (cinquenta reais) por cada pessoa indicada que, após validação, venha a contratar a proteção veicular ofertada pelo LEADFLOW por meio do programa de indicação.</p>
            ...
            <div>
              ...
              <p>4.1. O LEADFLOW realiza o tratamento de dados pessoais dos participantes do programa em conformidade com a Lei nº 13.709/2018 (Lei Geral de Proteção de Dados – LGPD).</p>
              ...
              <p className="mt-2">4.3. O LEADFLOW poderá compartilhar dados com terceiros estritamente necessários à execução do programa, como processadores de pagamento, serviços antifraude e empresas de tecnologia contratadas.</p>
            ...
            <div>
              ...
              <p>6.1. O LEADFLOW poderá, a seu critério, alterar os termos deste programa a qualquer tempo, mediante aviso prévio no aplicativo.</p>
            ...
            <div className="border-t pt-4">
              <p className="font-semibold">LEADFLOW - Grupo G3PROFIT</p>
