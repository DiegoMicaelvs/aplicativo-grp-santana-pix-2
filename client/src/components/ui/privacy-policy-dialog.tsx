    ...
    <Dialog>
      ...
      <DialogContent className="max-w-4xl max-h-[80vh]">
        <DialogHeader>
          ...
          <DialogDescription>
            Programa "Indique e Ganhe" - Kong Pix Proteção Veicular
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4 text-sm">
            <div>
              <p className="font-semibold">
                Kong Pix Proteção Veicular, pessoa jurídica de direito privado, com sede em território nacional, doravante denominada "KONG PIX", apresenta os termos abaixo para a participação no programa de incentivo denominado "Indique e Ganhe", disponibilizado por meio de seu aplicativo oficial.
              </p>
              <p className="mt-2">
            ...
            <div>
              ...
              <p>1.1. O programa "Indique e Ganhe" tem como finalidade incentivar a divulgação e o crescimento da base de usuários da plataforma da KONG PIX, mediante bonificação por indicações válidas realizadas por usuários cadastrados.</p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2">2.3. A KONG PIX reserva-se o direito de recusar cadastros ou desconsiderar indicações em caso de suspeita de fraude, duplicidade, inconsistência de dados ou qualquer outra irregularidade identificada durante a validação.</p>
            ...
            <div>
              ...
              <p className="mt-2">3.4. Os valores serão pagos exclusivamente por meio dos dados bancários ou contas cadastradas e validadas pelo próprio usuário no aplicativo. A KONG PIX não se responsabiliza por erros de informação ou por dados incompletos/inválidos fornecidos pelo participante.</p>
              <p className="mt-2">3.5. Além da bonificação de R$ 3,00 por cada indicação válida, o usuário também fará jus ao recebimento adicional de R$ 50,00 (cinquenta reais) por cada pessoa indicada que, após validação, venha a contratar a proteção veicular ofertada pela KONG PIX por meio do programa de indicação.</p>
            ...
            <div>
              ...
              <p>4.1. A KONG PIX realiza o tratamento de dados pessoais dos participantes do programa em conformidade com a Lei nº 13.709/2018 (Lei Geral de Proteção de Dados – LGPD).</p>
            ...
            <div>
              ...
              <p>6.1. A KONG PIX poderá, a seu critério, alterar os termos deste programa a qualquer tempo, mediante aviso prévio no aplicativo.</p>
            ...
            <div className="border-t pt-4">
              <p className="font-semibold">KONG PIX PROTEÇÃO VEICULAR</p>
