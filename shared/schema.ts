...
// Referral statuses: pending, processing, converted, rejected, validated, paid, falso
export type ReferralStatus = "pending" | "processing" | "converted" | "rejected" | "validated" | "paid" | "falso";
...
export const updateReferralStatusSchema = z.object({
  status: z.enum(["pending", "processing", "converted", "rejected", "validated", "paid", "falso"]),
